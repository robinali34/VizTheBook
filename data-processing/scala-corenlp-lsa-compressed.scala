...
// Recipe inputs
val largest_raw = dkuContext.getDataFrame(sqlContext, "largest-raw-compressed")
val lemmatized = largest_raw.withColumn("lemmatized", lemma(col("body_text")))
...
val compressed_lsa = tfidf_large;

dkuContext.save("compressed-lsa", compressed_lsa);
